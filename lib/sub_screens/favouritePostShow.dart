...
class FavouritePostShow extends StatefulWidget {
  int index;
  Post post;
  FavouritePostShow({required this.index, required this.post});

  @override
  _FavouritePostShowState createState() => _FavouritePostShowState();
}

class _FavouritePostShowState extends State<FavouritePostShow> {
  String _groupName = '';
          ...
          Row(
            children: [
              Padding(
                ...
                child: Text(
                  postProvider.favouriteList[widget.index].totalFollowers,
                  style: TextStyle(
              ...
              Padding(
                ...
                child: Text(
                  postProvider.favouriteList[widget.index].totalComments,
                  style: TextStyle(
                      color: Colors.black, fontSize: size.width * .038),
                ),
              ),
              ...
              Padding(
                padding: EdgeInsets.only(left: size.width * .04),
                child: Text(
                  postProvider.favouriteList[widget.index].totalShares,
                  style: TextStyle(
                      color: Colors.black, fontSize: size.width * .038),
                ),
              ),
                ...
                if (snapshot2.docs.length != 0) {
                  ...
                  await FirebaseFirestore.instance
                    ...
                    postProvider.setTotalShares(widget.post.postId, null, null,
                        widget.index, null, null, userProvider);
                    Navigator.pop(context);
