...
import 'package:pet_lover/utils/message_bubble.dart';
...
class RechargeMessageStream extends StatefulWidget {
  ...
  RechargeMessageStream({this.followingName,this.followingNumber,this.followerName,this.followerNumber,this.sender});
...
class _RechargeMessageStreamState extends State<RechargeMessageStream> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore.collection('Chats/${widget.followerNumber} ${widget.followingNumber}/messages')
