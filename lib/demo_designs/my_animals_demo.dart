...
class MyAnimalsDemo extends StatefulWidget {
  int index;
  Post post;
  MyAnimalsDemo({required this.index, required this.post});
          ...
          ListTile(
            ...
            trailing: PopupMenuButton<MyAnimalItemMenu>(
                onSelected: (item) => onSelectedMenuItem(
                    context, item, animalProvider, postProvider, userProvider),
                itemBuilder: (context) => [
          ...
          Row(
            children: [
              Padding(
                ...
                child: Text(
                  postProvider.userPosts[widget.index].totalFollowers,
                  style: TextStyle(
              ...
              Padding(
                ...
                child: Text(
                  postProvider.userPosts[widget.index].totalComments,
                  style: TextStyle(
                      color: Colors.black, fontSize: size.width * .038),
                ),
              ),
              ...
              Padding(
                padding: EdgeInsets.only(left: size.width * .04),
                child: Text(
                  postProvider.userPosts[widget.index].totalShares,
                  style: TextStyle(
                      color: Colors.black, fontSize: size.width * .038),
                ),
              ),
            ...
            if (snapshot2.docs.length != 0) {
              ...
              await FirebaseFirestore.instance
                ...
                postProvider.setTotalShares(widget.post.postId, null, null,
                    null, widget.index, null, userProvider);
                Navigator.pop(context);
