...
class ShowPost extends StatefulWidget {
  int index;
  Post post;
  ShowPost({required this.index, required this.post});
          ...
          Row(
            children: [
              Padding(
                ...
                child: Text(
                  postProvider.allPosts[widget.index].totalFollowers,
                  style: TextStyle(
              ...
              Padding(
                ...
                child: Text(
                  postProvider.allPosts[widget.index].totalComments,
                  style: TextStyle(
                      color: Colors.black, fontSize: size.width * .038),
                ),
              ),
              ...
              Padding(
                padding: EdgeInsets.only(left: size.width * .04),
                child: Text(
                  postProvider.allPosts[widget.index].totalShares,
                  style: TextStyle(
                      color: Colors.black, fontSize: size.width * .038),
                ),
              ),
